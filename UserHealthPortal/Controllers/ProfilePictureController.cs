...
namespace UserHealthPortal.Controllers
{
    public class ProfilePictureController : Controller
    {
        ...
        public void ChangeProfile()
        {
            ...
            string[] getImageExtension = path.Split('.');
            string ext = getImageExtension[getImageExtension.Length - 1];

            Response.ContentType = _mappings["." + ext];
            string physicalFileName = path;
            Response.WriteFile(physicalFileName);
            //return base.File(path, "image/jpeg/png/pdf");
        }
